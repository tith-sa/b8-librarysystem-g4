    ...
    <div class="flex justify-between px-4">
      ...
      <div class="w-90 h-20 flex justify-between">
        ...
        <div class=" rounded-full mt-2">
          <img class="w-20 h-[95%] shadow-xl rounded-full" :src="makara" alt="Image">
        </div>
        <div>
          <router-link to="/Login" class="rounded-xl text-white ">
              <div class="rounded-xl px-4 py-2 ms-4 bg-pink-500 mt-5 hover:bg-pink-800 hover:shadow-2xl">
